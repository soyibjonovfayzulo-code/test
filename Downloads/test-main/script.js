...
function bindAuth() {
  ...
  const texnooAuthBtn = $("#texnooAuthBtn");
  if (texnooAuthBtn) {
    texnooAuthBtn.addEventListener("click", () => {
      if (window.TexnooAuth) {
        window.TexnooAuth.initiateLogin(true);
      }
    });
  }
}
...
function bindSettings() {
  ...
  const syncTexnooSettingsBtn = $("#syncTexnooSettingsBtn");
  if (syncTexnooSettingsBtn) {
    syncTexnooSettingsBtn.addEventListener("click", () => {
      if (window.TexnooAuth) {
        window.TexnooAuth.initiateLogin(true);
      }
    });
